...
func GetAllMetaInfosByDataStoreSearchParam(param *datastore_types.DataStoreSearchParam) []*types.MetaBinary {
	...
	rows, err := Postgres.Query(`
		...
		referred_time,
		expire_time
		FROM meta_binaries ORDER BY updated_time DESC LIMIT $1`,
